...
<html lang="en">
    <head>
        ...
        <link href="vendors/full-page/jquery.fullpage.min.css" rel="stylesheet">
    ...
    <body class="home_parallax">
        
        <!--================Full Width Menu Area =================-->
        <header class="shop_header_area parallax_menu">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav justify-content-end">
                            ...
                            <li class="settings"><a href="#"><i class="icon-settings icons"></i></a></li>
                        </ul>
                    </div>
                </nav>
            </div>
        ...
        <section class="full_page_area">
            <section id="fullpage" class="full_page_inner">
                ...
                <div class="section" style="background: url(img/home-parallax/parallax-2.jpg); background-size: cover; background-repeat: no-repeat; background-position: center center;">
                    <div class="paper_inner">
                ...
                <div class="section" style="background: url(img/home-parallax/parallax-3.jpg); background-size: cover; background-repeat: no-repeat; background-position: center center;">
                ...
                <div class="section" style="background: url(img/home-parallax/parallax-4.jpg); background-size: cover; background-repeat: no-repeat; background-position: center center;">
                    <div class="paper_inner">
                        <div class="parallax_style_one">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        ...
        <script src="vendors/full-page/jquery.fullpage.min.js"></script>
