            ...
            <div class="carousel_top_h_inner">
                ...
                <div class="float-md-right">
                    <?php
                        ...
                        session_start();
                        $sqlt = "SELECT count(*) as sum_pro FROM wishlist where id_client={$_SESSION['idUser']} group by id_client";
                        $resultt = mysqli_query($conn, $sqlt);
                        $rowt = $resultt->fetch_assoc();
                        $sum_pro = $rowt["sum_pro"];?>
                    <ul class="account_list">
                        <li><a href="#">My Account</a></li>
                        <li><a href="shopping-cart2.php">Wish List (<?php echo $sum_pro;?>)</a></li>
    ...
    <div class="carousel_menu_inner">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="home-sidebar.php"><img src="img/logo.png" alt=""></a>
